...
class bilal_ccritic_bignnAgent(BaseAgent):

    def __init__(self, *args, **kwargs):
        super(bilal_ccritic_bignnAgent, self).__init__(*args, **kwargs)
        self.gnet = Net()
        self.gnet.load_state_dict(torch.load('bilal_ccritic_bignn170K.pt'))
        self.game_step = 0
